...
int main(int argc, char **argv, char **env)
{
	...
	_track_shell *raw;
	_track_shell _raw_data;
	
	_raw_data.keepRunning = 1;
	_raw_data.countprocess = 0;
        _raw_data.mode = "interactive";
        _raw_data.argc = argc;
        _raw_data.argv = argv;
        _raw_data.env = env;
        _raw_data.current_fn = "main";
        _raw_data._issatty = -1;
        _raw_data.path = NULL;
        _raw_data.args_path = NULL;
        _raw_data.nargs_path = 0;
        _raw_data.fullpath = NULL;	
	raw = &_raw_data;
